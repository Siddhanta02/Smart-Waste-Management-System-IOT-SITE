/*
  # Initial Schema for Recyclean Application

  1. New Tables
    - users: Extended user profiles
    - complaints: User-submitted waste management issues
    - products: Marketplace items
    - orders: User purchases
    - order_items: Individual items in orders
    - blogs: Environmental blog posts
    - quizzes: Educational quizzes
    - quiz_questions: Quiz content
    - quiz_attempts: User quiz participation
    - drivers: Waste collection personnel
    - driver_tasks: Assigned collection tasks
